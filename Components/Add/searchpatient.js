...
export class searchpatient extends HTMLElement {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        this.render();
        var reply = ipcRenderer.sendSync('searcpatienthhelloSync',this.getAttribute("searchid") );
        ...
        search.addEventListener('click', async () => {
            ...
            onclick = new searchpatient1(search.value);
         });
...
<button type="submit" id="logout" style="margin-top:56px; margin-left:1200px; background-color:red;">Log Out</button> 
<button type="submit" id="myInput1" style="margin-top:80px; margin-left:120px; background-color:rgba(26, 144, 143, 0.56); " >search</button>
<input type="text" id="search1" name="search" placeholder="Search for names.." title="Type in a name" style="width:250px; margin-top:-38px; margin-left:20px;">           
...
customElements.define('search-patient', searchpatient)